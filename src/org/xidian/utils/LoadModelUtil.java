...
public class LoadModelUtil {
	...
	//资源是否可靠
 	public static LinkedList<Integer> up = new LinkedList<>();  //up用于存放不可靠资源库所
 	static LinkedList<Integer> rp = new LinkedList<>();  //rp用于存放资源库所
	...
	public static Set<Integer> badTrans = new HashSet<>();
	public static Map<Integer, List<Integer>> resourceWeightMap = new LinkedHashMap<>();
...
//			BaseData.rootState = new StateNode(PetriModel.ininmarking.getMarking(), 1, 1);
    	...
    	new PetriModel(new Matrix(preMatrix, "preMatrix"), 
    			...
    			new Transition(transation), new Marking(marking));
	}
